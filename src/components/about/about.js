      ...
      <div className='divider'>
        ...
        <div className='left-side'>
          ...
          <p className='heading-text'>
            I'm a <b>Software Enthusiast</b>, UI Designer & passionate Front-End focused Web Developer. My Design creates <b>great User Experiences</b> that lead to the overall success of the Product.
            <br /> <br />
            ...
            <br /> <br />
            Since then, I've created a few websites but have primarily focused on my own <button className='navigationBT' onClick={handleClickProjects}> projects</button>
            , since, as we all know, building projects is the most convenient way to learn.
            <br /> <br />
            I am specialized in <b>HTML</b>, <b>CSS</b> & <b>JavaScript</b> and use as frameworks mainly <b>ReactJS</b>, sometimes <b>TailwindCSS</b>. As operating system, I prefer <b>Windows</b>, while I feel most comfortable with <b>Git</b> in terms of version control systems.
            <br /><br />
