      ...
      <div className='divider'>
        <div className='left-side'>
          ...
          <p className='heading-text'>I'm a <b>Software Enthusiast</b>, UI Designer & passionate Front-End focused Web Developer. My Design creates <b>great User Experiences</b> and leads to the overall success of the Product.<br /> <br />
            ...
            I am specialized in <b>HTML</b>, <b>CSS</b> & <b>JavaScript</b> and use as frameworks mainly <b>ReactJS</b>, sometimes TailwindCSS. As operating system I prefer <b>Windows</b>, while I feel most comfortable with <b>Git</b> in terms of version control systems.<br /><br />
